...
public class RobotHead extends PApplet{
    ...
    public void mouth(float mouthX, float mouthY){
        triangle(mouthX-50, mouthY, mouthX +250, mouthY, mouthX + 100, mouthY + 75);


    }
    public void leftEar(float xEar,float yEar){
        fill(244,121,0);
        rect(xEar,yEar,25,100);
        rect(xEar - 25, yEar + 12, 25, 75);
        rect(xEar - 50, yEar + 24, 25, 50);
        line(xEar - 38, yEar + 25, xEar - 38, yEar - 200);
        fill(255, 255, 255);
        ellipse(xEar - 38, yEar - 200, 30, 30);
